...
class getMessenger_Bus_Default_Middleware_HandleMessageService extends Tramity_Apps_Backend_BackendKernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['messenger.bus.default.middleware.handle_message'] = $instance = new \Symfony\Component\Messenger\Middleware\HandleMessageMiddleware(($container->privates['messenger.bus.default.messenger.handlers_locator'] ??= new \Symfony\Component\Messenger\Handler\HandlersLocator([])), false);
