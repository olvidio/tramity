...
$sql0 = "SELECT id_entrada FROM $centro.entrada_adjuntos ORDER BY id_item";
...
for ($i = 0; $init < $num_adjuntos; $i++) {
    $sql = "SELECT id_item FROM $centro.entrada_adjuntos ORDER BY id_item LIMIT $inc OFFSET $init";
