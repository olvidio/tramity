...
ALTER TABLE public.entrada_compartida_adjuntos ADD CONSTRAINT entrada_compartida_adjuntos_fk_ent FOREIGN KEY (id_entrada_compartida) REFERENCES public.entradas_compartidas (id_entrada_compartida) ON DELETE CASCADE;
