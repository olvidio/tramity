...
ALTER TABLE public.entrada_doc
    ADD CONSTRAINT entrada_doc_fk_ent FOREIGN KEY (id_entrada) REFERENCES public.entradas (id_entrada) ON DELETE CASCADE;
...
ALTER TABLE public.entrada_adjuntos
    ADD CONSTRAINT entrada_adjuntos_fk_ent FOREIGN KEY (id_entrada) REFERENCES public.entradas (id_entrada) ON DELETE CASCADE;
