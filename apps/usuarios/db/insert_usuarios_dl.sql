...
SELECT pg_catalog.setval('nombre_del_esquema.aux_cargos_id_cargo_seq', 50, true);
---
--- Para la tabla cargos_grupos de la dl
INSERT INTO nombre_del_esquema.cargos_grupos (id_grupo, id_cargo_ref, descripcion, miembros)
VALUES (1, 9, 'todos los d', '{18,20,21,23,24,10,11,12}');
--- empezar a contar en 2.
SELECT pg_catalog.setval('nombre_del_esquema.cargos_grupos_id_grupo_seq', 2, true);
