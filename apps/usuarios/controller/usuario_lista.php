...
$url_form = Hash::link(ConfigGlobal::getWeb() . '/apps/usuarios/controller/usuario_form.php');
$url_form_pwd = Hash::link(ConfigGlobal::getWeb() . '/apps/usuarios/controller/usuario_form_pwd.php');
$url_eliminar = Hash::link(ConfigGlobal::getWeb() . '/apps/usuarios/controller/usuario_update.php');
$url_actualizar = Hash::link(ConfigGlobal::getWeb() . '/apps/usuarios/controller/usuario_lista.php');
