...
$url_nuevo = web\Hash::link(core\ConfigGlobal::getWeb() . '/apps/usuarios/controller/cargo_grupo_form.php?' . http_build_query($aQuery));

$url_form = web\Hash::link(core\ConfigGlobal::getWeb() . '/apps/usuarios/controller/cargo_grupo_form.php');
$url_eliminar = web\Hash::link(core\ConfigGlobal::getWeb() . '/apps/usuarios/controller/cargo_grupo_update.php');
$url_actualizar = web\Hash::link(core\ConfigGlobal::getWeb() . '/apps/usuarios/controller/cargo_grupo_lista.php');
