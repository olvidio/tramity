...
$filenameOld = ServerConf::DIR . '/apps/' . $Q_grupo . '/legacy/zzzGestor' . $Q_clase . 'Old.php';
...
$dir_infra = ServerConf::DIR . '/apps/' . $Q_grupo . '/infrastructure';
...
$dir_repositories = ServerConf::DIR . '/apps/' . $Q_grupo . '/domain/repositories';
