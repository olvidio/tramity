...
switch ($Qfiltro) {
    ...
    case 'enviar':
        $devolver = TRUE;
        $pagina_cancel = web\Hash::link('apps/escritos/controller/escrito_lista.php?'.http_build_query($a_cosas));
        break;
    case 'en_buscar':
        $a_condicion = [];
...
$pagina_actualizar = web\Hash::link('apps/escritos/controller/escrito_form.php?'.http_build_query($a_cosas));
