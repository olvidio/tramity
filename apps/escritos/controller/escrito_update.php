    ...
    case 'eliminar':
        ...
        if (!empty($Q_id_escrito)) {
            ...
            if (empty($f_salida) || ConfigGlobal::role_actual() === 'secretaria') {
                ...
                // borrar el texto: Etherpad/documento
                $oTextoDelEscritoNew = new TextoDelEscrito($oEscrito->getTipo_doc(), TextoDelEscrito::ID_ESCRITO, $Q_id_escrito);
                $oTextoDelEscritoNew->eliminar();
