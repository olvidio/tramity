    ...
    */
    ...
    private function setAllAtributes($aDades)
    {
        ...
        */
        ...
        if (array_key_exists('f_cal_acabado', $aDades)) {
            $this->setF_acabado($aDades['f_cal_acabado']);
        }
        if (array_key_exists('f_cal_plazo', $aDades)) {
            $this->setF_plazo($aDades['f_cal_plazo']);
        }
        if (array_key_exists('f_cal_start', $aDades)) {
            $this->setF_inicio($aDades['f_cal_start']);
        }
        if (array_key_exists('f_cal_end', $aDades)) {
            $this->setF_end($aDades['f_cal_end']);
        }
        ...
        if (array_key_exists('categorias', $aDades)) {
            $this->setCategorias($aDades['categorias']);
        }
        if (array_key_exists('encargado', $aDades)) {
            $this->setEncargado($aDades['encargado']);
        }
        if (array_key_exists('ref_prot_mas', $aDades)) {
            $this->setRef_prot_mas($aDades['ref_prot_mas']);
        }
        ...
        if (array_key_exists('id_reg', $aDades)) {
            $this->setId_reg($aDades['id_reg']);
        }
        if (array_key_exists('oficinas', $aDades)) {
            $this->setOficinas($aDades['oficinas']);
        }

        if (array_key_exists('exdates', $aDades)) {
            $this->setExdates($aDades['exdates']);
        }
    }
    ...
    private function ins_pendiente($aDades)
    {
        ...
        if (!empty($f_cal_inicio)) {
            $args['DTSTART'] = $f_cal_inicio;
        } else {
            $args['DTSTART'] = $f_cal_plazo;
        }
        if (!empty($f_cal_end)) {
    ...
    /**
     * Desa els ATRIBUTOS de l'objecte
     *
     */
