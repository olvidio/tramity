...
ALTER TABLE public.acciones
    ADD CONSTRAINT acciones_fk_exp FOREIGN KEY (id_expediente) REFERENCES public.expedientes (id_expediente) ON DELETE CASCADE;
ALTER TABLE public.acciones
    ADD CONSTRAINT acciones_fk_esc FOREIGN KEY (id_escrito) REFERENCES public.escritos (id_escrito) ON DELETE CASCADE;
