...
<br>
<span class="link"
      onclick="fnjs_update_div('#main','apps/davical/controller/proves.php?que=crear_usuario&user_no=1002')">
...
<br>
<span class="link"
      onclick="fnjs_update_div('#main','apps/davical/controller/proves.php?que=crear_resource&user_no=1005')">
 	4: Modificar Resuorce (1005)
</span>
<br>
<span class="link"
      onclick="fnjs_update_div('#main','apps/davical/controller/proves.php?que=crear_coleccion&user_no=1005')">
 	5: Crear Coleccion para oficina_vsm (1005)
</span>
<br>
<span class="link"
      onclick="fnjs_update_div('#main','apps/davical/controller/proves.php?que=crear_oficina&oficina=vsg')">
 	6: Oficina Tot (vsg)
</span>
<br>
<span class="link"
      onclick="fnjs_update_div('#main','apps/davical/controller/proves.php?que=add_user&oficina=vsg&user=of1sg')">
