...
class Collection extends core\ClasePropiedades
{
    ...
    function __construct($a_id = null)
    {
        ...
        if (is_array($a_id)) {
            ...
            foreach ($a_id as $nom_id => $val_id) {
                if (($nom_id === 'collection_id') && $val_id !== '') {
                    $this->icollection_id = (int)$val_id;
                }
            }
        } else {
            if (isset($a_id) && $a_id !== '') {
                $this->icollection_id = (int)$a_id;
    ...
    public function DBGuardar()
    {
        ...
        if (core\is_true($aDades['is_calendar'])) {
            $aDades['is_calendar'] = 'true';
        } else {
            $aDades['is_calendar'] = 'false';
        }
        if (core\is_true($aDades['public_events_only'])) {
            $aDades['public_events_only'] = 'true';
        } else {
            $aDades['public_events_only'] = 'false';
        }
        if (core\is_true($aDades['publicly_readable'])) {
            $aDades['publicly_readable'] = 'true';
        } else {
            $aDades['publicly_readable'] = 'false';
        }
        if (core\is_true($aDades['is_addressbook'])) {
            $aDades['is_addressbook'] = 'true';
        } else {
            $aDades['is_addressbook'] = 'false';
        }
        ...
        if ($bInsert === FALSE) {
            ...
            $this->icollection_id = $oDbl->lastInsertId('dav_id_seq');
        }
    ...
    private function setAllAtributes($aDades, $convert = FALSE)
    {
        ...
        if (array_key_exists('parent_container', $aDades)) {
            $this->setParent_container($aDades['parent_container']);
        }
        ...
        if (array_key_exists('dav_displayname', $aDades)) {
            $this->setDav_displayname($aDades['dav_displayname']);
        }
        if (array_key_exists('is_calendar', $aDades)) {
            $this->setIs_calendar($aDades['is_calendar']);
        }
        if (array_key_exists('created', $aDades)) {
            $this->setCreated($aDades['created'], $convert);
        }
        if (array_key_exists('modified', $aDades)) {
            $this->setModified($aDades['modified'], $convert);
        }
        if (array_key_exists('public_events_only', $aDades)) {
            $this->setPublic_events_only($aDades['public_events_only']);
        }
        if (array_key_exists('publicly_readable', $aDades)) {
            $this->setPublicly_readable($aDades['publicly_readable']);
        }
        ...
        if (array_key_exists('is_addressbook', $aDades)) {
            $this->setIs_addressbook($aDades['is_addressbook']);
        }
        if (array_key_exists('resourcetypes', $aDades)) {
            $this->setResourcetypes($aDades['resourcetypes']);
        }
        if (array_key_exists('schedule_transp', $aDades)) {
            $this->setSchedule_transp($aDades['schedule_transp']);
        }
        if (array_key_exists('timezone', $aDades)) {
            $this->setTimezone($aDades['timezone']);
        }
    ...
    /**
     * Recupera tots els ATRIBUTOS de Collection en un array
     *
     * @return array aDades
     */
    function getTot()
