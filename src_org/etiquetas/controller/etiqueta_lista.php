...
$url_nuevo = web\Hash::link(core\ConfigGlobal::getWeb() . '/src/etiquetas/controller/etiqueta_form.php?' . http_build_query($aQuery));

$url_form = web\Hash::link(core\ConfigGlobal::getWeb() . '/src/etiquetas/controller/etiqueta_form.php');
$url_eliminar = web\Hash::link(core\ConfigGlobal::getWeb() . '/src/etiquetas/controller/etiqueta_update.php');
$url_actualizar = web\Hash::link(core\ConfigGlobal::getWeb() . '/src/etiquetas/controller/etiqueta_lista.php');
