...
$url_update = ConfigGlobal::getWeb() . '/src/entidades/controller/entidad_update.php';

$txt_guardar = _("guardar datos nombre_entidad");

$pagina_cancel = Hash::link('src/entidades/controller/entidad_lista.php?' . http_build_query([]));
...
$oView->renderizar('entidad_form.html.twig', $a_campos);
