...
$aQuery = ['nuevo' => 1];
$url_nuevo = Hash::link(ConfigGlobal::getWeb() . '/src/entidades/controller/entidad_form.php?' . http_build_query($aQuery));

$url_form = Hash::link(ConfigGlobal::getWeb() . '/src/entidades/controller/entidad_form.php');
$url_eliminar = Hash::link(ConfigGlobal::getWeb() . '/src/entidades/controller/entidad_update.php');
$url_actualizar = web\Hash::link(core\ConfigGlobal::getWeb() . '/src/entidades/controller/entidad_lista.php');
