...
switch ($Q_tipo_lista) {
    ...
    case 'lst_oficinas':
        ...
        foreach ($cOficinas as $id_oficina => $sigla) {
            $ira = "src/busquedas/controller/lista_permanentes.php?tipo_lista=oficina&id_oficina=$id_oficina";
    ...
    default:
        ...
        foreach ($a_anys as $any) {
            $ira = "src/busquedas/controller/lista_permanentes.php?tipo_lista=any&any=$any";
