...
$dir_legacy = ServerConf::DIR . '/src/' . $grupo . '/legacy';
...
$grupo = !empty($Q_grupo) ? $Q_grupo : "actividades";
$filename = ServerConf::DIR . '/src/' . $grupo . '/model/entity/' . $Q_clase . '.php';
$filenameOld = ServerConf::DIR . '/src/' . $grupo . '/legacy/zz' . $Q_clase . 'Old.php';
...
$filename = ServerConf::DIR . '/src/' . $grupo . '/model/entity/Gestor' . $Q_clase . '.php';
$filenameOld = ServerConf::DIR . '/src/' . $grupo . '/legacy/zzzGestor' . $Q_clase . 'Old.php';
if (file_exists($filename)) {
    rename($filename, $filenameOld);
    /* rename class if exists */
    $content = file_get_contents($filenameOld);
...
$dir_infra = ServerConf::DIR . '/src/' . $grupo . '/infrastructure';
if (!is_dir($dir_infra)) {
    mkdir($dir_infra);
}
...
$dir_repositories = ServerConf::DIR . '/src/' . $grupo . '/domain/repositories';
