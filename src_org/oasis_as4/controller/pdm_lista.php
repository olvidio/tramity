...
$aQuery = ['nuevo' => 1];
$url_nuevo = Hash::link(core\ConfigGlobal::getWeb() . '/src/oasis_as4/controller/pdm_form.php?' . http_build_query($aQuery));
$url_eliminar = Hash::link(core\ConfigGlobal::getWeb() . '/src/oasis_as4/controller/pdm_update.php');
$url_actualizar = Hash::link(core\ConfigGlobal::getWeb() . '/src/oasis_as4/controller/pdm_lista.php');
