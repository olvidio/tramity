...
$pagina_cancel = web\Hash::link('src/escritos/controller/salida_escrito.php?' . http_build_query($a_condicion));

$pagina_nueva = web\Hash::link('src/expedientes/controller/expediente_form.php?' . http_build_query($a_cosas));
$url_escrito = 'src/escritos/controller/salida_escrito.php';
...
$pagina_actualizar = web\Hash::link('src/escritos/controller/salida_escrito.php?' . http_build_query($a_cosas));
