...
$pagina = core\ConfigGlobal::getWeb() . '/src/escritos/controller/escrito_ver.php';
...
if (!empty($Q_id_escrito)) {
    ...
    $url_download_pdf_adjunto = $base_url . '/src/escritos/controller/adjunto_download_as_pdf.php';
    $url_download_pdf = $base_url . '/src/escritos/controller/escrito_download.php';
