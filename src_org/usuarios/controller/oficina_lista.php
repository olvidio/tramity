...
foreach ($cOficinas as $oOficina) {
    ...
    $pagina = web\Hash::link(core\ConfigGlobal::getWeb() . '/src/usuarios/controller/oficina_form.php?' . http_build_query(array('quien' => 'oficina', 'id_oficina' => $id_oficina)));
...
$url_nuevo = web\Hash::link(core\ConfigGlobal::getWeb() . '/src/usuarios/controller/oficina_form.php?' . http_build_query($aQuery));
$url_ajax = web\Hash::link(core\ConfigGlobal::getWeb() . '/src/usuarios/controller/oficina_update.php');
$url_actualizar = web\Hash::link(core\ConfigGlobal::getWeb() . '/src/usuarios/controller/oficina_lista.php');
