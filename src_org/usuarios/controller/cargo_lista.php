...
$url_nuevo = web\Hash::link(core\ConfigGlobal::getWeb() . '/src/usuarios/controller/cargo_form.php?' . http_build_query($aQuery));
$url_form = web\Hash::link(core\ConfigGlobal::getWeb() . '/src/usuarios/controller/cargo_form.php');
$url_ajax = web\Hash::link(core\ConfigGlobal::getWeb() . '/src/usuarios/controller/cargo_update.php');
$url_actualizar = web\Hash::link(core\ConfigGlobal::getWeb() . '/src/usuarios/controller/cargo_lista.php');
