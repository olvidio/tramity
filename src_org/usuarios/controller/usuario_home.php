...
// reunion = 4
$filtro = 'reunion';
$oExpedienteLista = new ExpedienteReunionLista($filtro);
$active = ($filtro === $Q_filtro) ? 'active' : '';
$aQuery = ['filtro' => $filtro];
$pag_lst = web\Hash::link('src/expedientes/controller/expediente_lista.php?' . http_build_query($aQuery));
$num_orden = 4;
...
$oExpedienteLista = new ExpedienteAcabadosEncargadosLista($filtro);
$active = ($filtro === $Q_filtro) ? 'active' : '';
$aQuery = ['filtro' => $filtro];
$pag_lst = web\Hash::link('src/expedientes/controller/expediente_lista.php?' . http_build_query($aQuery));
$num_orden = 8;
...
// copias = 10
$filtro = 'copias';
$oExpedienteLista = new ExpedienteCopiasLista($filtro);
$active = ($filtro === $Q_filtro) ? 'active' : '';
$aQuery = ['filtro' => $filtro];
$pag_lst = web\Hash::link('src/expedientes/controller/expediente_lista.php?' . http_build_query($aQuery));
$num_orden = 10;
...
if (is_true(ConfigGlobal::soy_dtor())) {
    ...
    $pag_lst = web\Hash::link('src/busquedas/controller/ver_tabla.php?' . http_build_query($aQuery));
    $num_orden = 21;
...
$active = ($filtro === $Q_filtro) ? 'active' : '';
$aQuery = ['filtro' => $filtro];
$pag_lst = web\Hash::link('src/busquedas/controller/lista_permanentes.php?' . http_build_query($aQuery));
$num_orden = 22;
...
$pag_lst = web\Hash::link('src/documentos/controller/documentos_lista.php?' . http_build_query($aQuery));
$num_orden = 40;
$text = _("documentos");
