...
$oGesUsuarios = new UsuarioRepository();
...
foreach ($oUsuarioColeccion as $oUsuario) {
    ...
    if (!empty($id_cargo_preferido) && ConfigGlobal::nombreEntidad() !== 'admin') {
        $oCargo = $CargoRepository->findById($id_cargo_preferido);
        if ($oCargo !== null) {
...
$url_nuevo = Hash::link(ConfigGlobal::getWeb() . '/src/usuarios/controller/usuario_form.php?' . http_build_query($aQuery));

$url_form = Hash::link(ConfigGlobal::getWeb() . '/src/usuarios/controller/usuario_form.php');
$url_form_pwd = Hash::link(ConfigGlobal::getWeb() . '/src/usuarios/controller/usuario_form_pwd.php');
$url_eliminar = Hash::link(ConfigGlobal::getWeb() . '/src/usuarios/controller/usuario_update.php');
$url_actualizar = Hash::link(ConfigGlobal::getWeb() . '/src/usuarios/controller/usuario_lista.php');
