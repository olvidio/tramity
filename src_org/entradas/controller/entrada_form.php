...
$pagina_nueva = web\Hash::link('src/entradas/controller/entrada_form.php?' . http_build_query(['filtro' => $Q_filtro]));
if ($Q_filtro === 'en_buscar') {
    ...
    $pagina_cancel = web\Hash::link('src/entradas/controller/entrada_lista.php?' . http_build_query(['filtro' => $Q_filtro]));
    $str_condicion = '';
}
